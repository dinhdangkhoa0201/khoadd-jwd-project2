...
public class CarService {
    ...
    public CarService(CarRepository repository, MapsClient mapsClient, PriceClient clientsClient) {
        /**
        ...
        this.priceClient = clientsClient;
    ...
    public void delete(Long id) {
         ...
         *   If it does not exist, throw a CarNotFoundException
         */
        Car deletedCar = this.repository.findById(id).orElseThrow(CarNotFoundException::new);
